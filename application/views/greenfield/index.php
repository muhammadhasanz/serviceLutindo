...
<head>
    <meta charset="utf-8">
    <title>Greenfield | PT. Lutungan Indoutama</title>
                ...
                <div class="col-sm-12">
                    <div class="contact-mf">
                        <div id="contact" class="box-shadow-full">
                            ...
                            <div>
                                <form action="<?= base_url('lutindo/pesanan/greenfield'); ?>" method="post" role="form" class="contactForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <input type="text" name="type_tower" class="form-control" id="type_tower" placeholder="Greenfield" readonly value="Greenfield" />
                                                <div class="validation"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
